...
describe("Search", () => {
  test("GET /search?q=ram siya ram | Search All", async () => {
    const response = await fetch(`${BASE_URL}/search?q=ram siya ram`);
  ...
  test("GET /search?q=ram siya ram&camel=1 | Search All (Camel Case)", async () => {
    const response = await fetch(`${BASE_URL}/search?q=ram siya ram&camel=1`);
    expect(response.status).toBe(200);
  ...
  test("GET /search/songs?q=ram siya ram | Search Songs", async () => {
    const response = await fetch(`${BASE_URL}/search/songs?q=ram siya ram`);
    expect(response.status).toBe(200);
  ...
  test("GET /search/songs?q= | Search Songs (Error)", async () => {
    const response = await fetch(`${BASE_URL}/search/songs?q=`);
    expect(response.status).toBe(400);
  ...
  test("GET /search/albums?q=ram siya ram | Search Albums", async () => {
    const response = await fetch(`${BASE_URL}/search/albums?q=ram siya ram`);
    expect(response.status).toBe(200);
  ...
  test("GET /search/albums?q= | Search Albums (Error)", async () => {
    const response = await fetch(`${BASE_URL}/search/albums?q=`);
    expect(response.status).toBe(400);
  ...
  test("GET /search/playlists?q=ram siya ram | Search Playlists", async () => {
    const response = await fetch(`${BASE_URL}/search/playlists?q=ram siya ram`);
    expect(response.status).toBe(200);
  ...
  test("GET /search/playlists?q= | Search Playlists (Error)", async () => {
    const response = await fetch(`${BASE_URL}/search/playlists?q=`);
    expect(response.status).toBe(400);
  ...
  test("GET /search/artists?q=arijit singh | Search Artists", async () => {
    const response = await fetch(`${BASE_URL}/search/artists?q=arijit singh`);
    expect(response.status).toBe(200);
  ...
  test("GET /search/artists?q= | Search Artists (Error)", async () => {
    const response = await fetch(`${BASE_URL}/search/artists?q=`);
    expect(response.status).toBe(400);
  ...
  test("GET /search/podcasts?q=ram siya ram | Search Shows/Podcasts", async () => {
    const response = await fetch(`${BASE_URL}/search/podcasts?q=ram siya ram`);
    expect(response.status).toBe(200);
  ...
  test("GET /search/podcasts?q= | Search Shows/Podcasts (Error)", async () => {
    const response = await fetch(`${BASE_URL}/search/podcasts?q=`);
    expect(response.status).toBe(400);
